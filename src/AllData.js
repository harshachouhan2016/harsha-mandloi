...
function RedButton() {
  ...
  const experiences = [
    ...
    return (
      ...
      {/* Sidebar Navigation */}
      <nav className="w-100 text-center h-screen fixed top-0 left-0 bg-slate p-8 border-gray-800 hidden md:block  border-r">
         
         <div className="myImage"></div> 
        <div className="flex justify-between items-center mb-3">
          <h1 className="text-3xl font-bold text-slate-200">Harsha Mandloi</h1>
        </div>
        ...
        <a href={resumePDF}
          className=" my-10 inline-flex mt-6 md:mt-0 pl-3 pt-2 border text-white-400 text-sm rounded hover:bg-white hover:text-slate-900 transform-gpu  "
      ...
      <main className="scroll-smooth md:pl-80 pl-80 w-full main-bg border-l border-gray-800  md:p-10">
        {/* Hero Section */}
        <section id="hero" className="max-w-5xl mx-auto  py-10">
        <h1 className="text-4xl mb-6 font-bold"> Get to know me!</h1>
          {/* <h3 className="text-3xl mb-6 text-white font-light">About me</h3> */}
          <p className="mb-3 text-slate-500">
          I have over 10 years of experience designing and developing responsive, user-friendly websites, primarily focused on eCommerce platforms like Amazon Seller Central, Shopify, BigCommerce, Magento, and eBay. I specialize in creating dynamic UI components using <span className="text-slate-400 font-bold">HTML, CSS and JavaScript</span> to enhance performance and user experience. I also create visually engaging elements like banners, icons, and email templates using tools like <span className="text-slate-400 font-bold">Adobe Photoshop and InDesign</span>.</p>
           <p className="mb-3 text-slate-500"> My work has significantly improved the speed, accessibility, and responsiveness of high-traffic websites. Worked extensively with SonarQube to analyze and improve code quality, ensuring clean, maintainable, and secure code across all projects.</p> 
           <p className="mb-3 text-slate-500"> In Agile environments, I've collaborated closely with cross-functional teams, led client meetings, and managed production releases. I've worked alongside back-end developers and marketing teams to build features, resolve issues, and integrate APIs.I focus on continuous improvement through user feedback and analytics and have led custom development projects including GraphQL integration and site framework upgrades. I also provide client training and post-launch support to ensure smooth handoffs.
          </p>
        </section>
